...
import { GRENADE_IMAGE_DATA_URI } from '@/lib/image-constants';
        ...
        <div className="flex flex-col items-center justify-center gap-4">
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-secondary hover:bg-secondary/80 transition-colors"
              title="Follow on X"
          ...
          <div className="flex items-center gap-2">
            ...
            <img
              src={GRENADE_IMAGE_DATA_URI || "/placeholder.svg"}
              alt="Elias grenade"
              width={20}
              height={20}
              className="w-5 h-5"
